...
class ProductTaste(models.Model):
    ...
    def __str__(self):
        """Return string representation of the ProductTaste."""
        return str(self.name)

    def save(self, *args, **kwargs):
        """Save the ProductTaste instance and log the action."""
...
class ProductWeight(models.Model):
    ...
    def __str__(self):
        """Return string representation of the ProductWeight."""
        return str(self.name)

    def save(self, *args, **kwargs):
        """Save the ProductWeight instance and log the action."""
...
class ProductPackaging(models.Model):
    ...
    def __str__(self):
        """Return string representation of the ProductPackaging."""
        return str(self.name)

    def save(self, *args, **kwargs):
        """Save the ProductPackaging instance and log the action."""
