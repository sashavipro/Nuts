...
# Fix: Replaced os.path.join with Path / operator
...
AUTH_PASSWORD_VALIDATORS = [
    {
        # Fix: Wrapped long validator name
...
# Django sets a maximum of 1000 fields per form by default, but
# particularly complex page models can exceed this limit within
# Wagtail's page editor.
